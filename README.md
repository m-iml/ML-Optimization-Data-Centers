...
[![License: CC BY-NC-SA 4.0](https://img.shields.io/badge/License-CC_BY--NC--SA-lightgrey.svg)](http://creativecommons.org/licenses/by-nc-sa/4.0/)
...
Code and notebooks are released under the CC BY-NC-SA. The Frontier HPC & Facility Data is redistributed under the same CC license used by the original figshare deposit; see [`data/README.md`](data/README.md) for details.
